...
export default function Setting() {
  ...
  // Password update — independent from the notification toggles, its own button/state
  async function savePassword() {
    ...
    try {
      const res = await api.patch(`${AUTH_BASE_URL}/updatePassword`, {
        currentPassword,
        newPassword,
      });
      console.log(res, "updated password res");
