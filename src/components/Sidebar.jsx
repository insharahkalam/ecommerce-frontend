...
// import {
//   LayoutGrid, ShoppingCart, Package, Users, BarChart3, Settings, X, Bell,
// } from "lucide-react";
            ...
            return (
              <NavLink
                ...
                onClick={() => {
                  ...
                  if (isNotif) setUnreadCount(0); // page open karte hi badge clear
                }}
                className="nav-item flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-serif text-left"
                style={({ isActive }) => ({
                  background: isActive ? "rgba(249,115,22,0.12)" : "transparent",
              ...
              >
                <div className="relative">
                  ...
                  {isNotif && unreadCount > 0 && (
                    <span className="absolute -top-1.5 -right-1.5 bg-orange-500 text-white text-[10px] font-semibold rounded-full min-w-[16px] h-4 px-1 flex items-center justify-center">
